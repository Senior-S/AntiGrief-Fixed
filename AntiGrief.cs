...
namespace AntiGrief
{
    public class AntiGrief : RocketPlugin<AntiGriefConfig>
    {
        ...
        protected override void Load()
        {
            ...
            Logger.Log($"AntiGrief v{this.Assembly.GetName().Version}");
            Logger.Log("<<SSPlugins Fork>>");
        }
        ...
        private void OnPrePreLevelLoaded(int level)
        {
            ...
            for (int v = 0; v < vehicleList.Count; v++)
            {
                ...
                {
                    vAsset.GetType().GetProperty("BuildablePlacementRule", bindingFlags | BindingFlags.Public).SetValue(vAsset, EVehicleBuildablePlacementRule.AlwaysAllow, null);
